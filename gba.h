...
#define KEY_JUST_PRESSED(key, buttons, prevButtons) ((KEY_DOWN(key, buttons)) & ((KEY_DOWN(key, ~(prevButtons)))))
...
// Using this variable to count vBlanks. Initialized in gba.c and to be
// manipulated by waitForVBlank()
extern u32 vBlankCounter;

/**
 * Run a blocking loop until the start of next VBlank.
 */
